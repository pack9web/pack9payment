...
//          html.push('&nbsp;');
      ...
      html.push('<div class="cell16"><input type="button" src="https://www.paypal.com/en_US/i/btn/btn_cart_SM.gif" alt="Add to cart" name="Add to cart"  border="0" onclick="return VerifyName(\'item' + row + '\')"></div>\n');
